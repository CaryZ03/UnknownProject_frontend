<template>
  <div class="container">
    ...
    <!-- 选择团队界面 -->
    <el-dialog title="选择团队" :visible.sync="dialogVisible" width="40%" :modal-append-to-body="false"  class="class_dialog_hospital" >
    ...
    <!-- 新建团队界面 -->
    <el-dialog :visible.sync="createTeamDialogVisible" title="新建团队" :modal-append-to-body="false" class="class_dialog_hospital">
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="submitCreateTeam" size="mini">确定</el-button>
    </span>
  </el-dialog>
