  ...
  <div class="outcontainer">
    ...
    <section v-show="show" class="panel" id="1">
      ...
      <div class="rightTxt">
        ...
        <h2>便携式软件开发管理平台</h2>
        <h2>组建团队, 一键管理软件设计</h2>
        <h2>群聊私聊高效交流, 协作文档灵感碰撞</h2>
        <h2>设计原型直观简洁, 文件系统层次分明</h2>
        <h2>在开发中探索未知, 体验合作乐趣</h2>
      </div>
    </section>
    ...
    <section v-show="show" class="panel" id="5">
      <img
    ...
    <section v-show="show" class="panel" id="6">
      <img
      ...
      <div class="container">
        <div v-show="!this.$store.state.isLogin" class="wrapper active-popup">
          <span class="icon-close"
            ><i class="el-icon-close" style="color: black"></i
          ></span>
...
export default {
  ...
  methods: {
    ...
    //   //   this.sectionid == "1" ||
    //   //   this.sectionid == "3" ||
    //   //   this.sectionid == "5" || this.sectionid == "7"
    //   // ) {
    //   //   this.show = false;
    //   // } else {
    //   //   this.show = true;
    ...
    //       if (section.id == "1" || section.id == "3" || this.sectionid == "5" || this.sectionid == "7") {
    //         this.show = true;
    //       } else {
    //         this.show = false;
    //       }
